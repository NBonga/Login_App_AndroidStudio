...
public class ParentRecyclerViewAdapter extends RecyclerView.Adapter<ParentRecyclerViewAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            if (parentModelArrayList.get(position).movieCategory().equals("Category1")) {
                arrayList.add(new ChildModel(R.drawable.avatar,"Movie Name"));
                arrayList.add(new ChildModel(R.drawable.frozen,"Movie Name"));
                arrayList.add(new ChildModel( R.drawable.onward,"Movie Name"));
                arrayList.add(new ChildModel( R.drawable.turningred,"Movie Name"));
                arrayList.add(new ChildModel( R.drawable.parker,"Movie Name"));
                arrayList.add(new ChildModel( R.drawable.angrybirds,"Movie Name"));
            }

            // added in second child row
            if (parentModelArrayList.get(position).movieCategory().equals("Category2")) {
                arrayList.add(new ChildModel(R.drawable.blackwidow,"Movie Name"));
                arrayList.add(new ChildModel(R.drawable.loveagain,"Movie Name"));
                arrayList.add(new ChildModel( R.drawable.shazam,"Movie Name"));
                arrayList.add(new ChildModel( R.drawable.avatar,"Movie Name"));
                arrayList.add(new ChildModel( R.drawable.angrybirds,"Movie Name"));
                arrayList.add(new ChildModel( R.drawable.frozen,"Movie Name"));
            }
